  ...
  return (
    <Stack wrap direction="row" columnGap={32} rowGap={32}>
      <Link href="/get-started/accessibility/" passHref>
        <Card as="a" right={<Icon name="compass" dimension={24} />} vibrant hoverable>
          <Stack rowGap={32}>
            <Stack>
      ...
      <Link href="/design/foundations/colors/" passHref>
        <Card as="a" right={<Icon name="compass" fill="var(--highlight-green-foreground)" dimension={24} />} vibrant hoverable>
          <Stack rowGap={32}>
            <Stack>
      ...
      <Link href="/develop/installation/" passHref>
        <Card as="a" right={<Icon name="compass" fill="var(--highlight-yellow-foreground)" dimension={24} />} vibrant hoverable>
          <Stack rowGap={32}>
            <Stack>
              <Text size={16} dimmed={6} weight="bold">Start</Text>
              <Title as="h2" level="4">
      ...
      <Link href="/components/overview/" passHref>
        <Card as="a" right={<Icon name="compass" fill="var(--highlight-red-foreground)" dimension={24} />} vibrant hoverable>
          <Stack rowGap={32}>
            <Stack>
