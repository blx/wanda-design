...
Info Sates display impactful information about the status or the outcome of different app processes. In some contexts, they may even interrupt the experience requiring user input.
