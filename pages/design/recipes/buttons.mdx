...
Flat buttons are the less intrusive actions possibile you can use. They pairs well both secondary and primary actions.
...
Even if the button appearance can be applied to links between pages, we recommend to use textual link whenever possibile, and rely on the button style if the text link doesn't fit the requirements.
