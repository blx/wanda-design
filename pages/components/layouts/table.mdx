...
<Components.Button
  kind="secondary"
  as="a"
  href="https://react-data-table-component.netlify.app/?path=/docs/getting-started-kitchen-sink-ts--kitchen-sink-ts"
  aria-label="original API refernce"
  target="_blank"
...
<Props
  properties={[
    {
      name: "tab",
      description: "Move focus on interactive elements.",
    },
    {
      name: "enter",
      description:
        "when focusing an element of the table header, it toggle its sorting",
    },
    {
      name: "space",
      description: "when focusing a checkbox, toggles its state",
    },
  ]}
/>
