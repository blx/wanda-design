...
<Snackbar kind="info">
  <b>@wonderflow/config</b> package exposes predefined configurations which you
  have to use in order to compile all the elements from the design system. Read
...
If you're alread using custom postcss plugins you can merge them with the ones required by Wanda. If you declare a plugin which is already used by Wanda you'll overwrite it.
