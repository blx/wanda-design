...
Like other components, the size of thr `Textfield` can be controlled with the `dimension` property. If needed you can also add an icon to convey meaning.

<LiveArea>
  <Stack verticalAlign="end" direction="row" columnGap={8}>
    <Textfield type="date" dimension="big" icon="calendar" label="Label" />
    <Button dimension="big">Confirm</Button>
  </Stack>
</LiveArea>
...
<LiveArea>
  <Textfield invalid dimension="big" icon="user" type="text" label="Label" />
</LiveArea>
